...
class NullProvider:
    ...
    def run_script(self, script_name: str, namespace: dict[str, Any]):
        ...
        # Decalaring empty string variable
        script＿text = "        "
        #replacing unintended characters
        ...
        if os.path.exists(script_filename):
            ...
            #making executrable   script＿text
            script_code = compile(script＿text, script_filename, 'exec')#making it executable
